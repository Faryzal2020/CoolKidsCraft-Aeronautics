ServerEvents.tags('item', event => {
  ...
  if (Platform.isLoaded('herbsandharvest')) {
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:asparagus') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:avocado') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:barley') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:blackberry') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:blueberry') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:broccoli') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:cabbage') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:cauliflower') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:celery') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:cherries') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:corn') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:ginger_root') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:green_pepper') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:lemon') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:lettuce') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:lime') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:oats') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:onion') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:orange') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:peach') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:pear') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:pineapple') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:plum') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:radish') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:raspberry') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:rice') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:rye') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:wintersquash') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:strawberry') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:sweet_potato') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:tomato') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:turnip') })
    ...
    tags.forEach(tag => { event.add(tag, 'herbsandharvest:zucchini') })
  }
  ...
  if (Platform.isLoaded('herbsandharvest')) {
    ...
    spices.forEach(spice => { event.add('c:spices', spice) })
  }
...
ServerEvents.recipes(event => {
  if (Platform.isLoaded('merrymaking')) {
    ...
    }).id('kubejs:merrymaking/poultry_dinner')

    event.shapeless('merrymaking:latke', ['minecraft:potato', '#c:onions/onion', 'minecraft:egg', 'minecraft:wheat']).id('kubejs:merrymaking/latke')

    event.shapeless('merrymaking:sweet_potato_pie', ['#c:milk', 'minecraft:wheat', 'minecraft:sugar', 'minecraft:egg', '#c:vegetables/sweet_potato']).id('kubejs:merrymaking/sweet_potato_pie')

    event.shapeless('8xmerrymaking:icing', ['minecraft:sugar', '#c:milk', 'minecraft:bowl']).id('kubejs:merrymaking/icing')

    event.shapeless('8xmerrymaking:ground_ginger', ['#c:crops/ginger']).id('kubejs:merrymaking/ground_ginger')

    event.shapeless('merrymaking:cookie_dough', ['#c:milk', 'minecraft:wheat', 'minecraft:sugar', 'minecraft:egg']).id('kubejs:merrymaking/cookie_dough')

    event.shapeless('merrymaking:gingerbread_dough', ['merrymaking:ground_ginger', '#c:milk', 'minecraft:wheat', 'minecraft:sugar', 'minecraft:egg']).id('kubejs:merrymaking/gingerbread_dough')

    event.shapeless('merrymaking:harvest_tray', ['merrymaking:empty_tray', '#c:vegetables/sweet_potato', '#c:grain/corn', 'minecraft:carrot', 'minecraft:apple', 'minecraft:potato', 'minecraft:sweet_berries', 'minecraft:beetroot', 'minecraft:wheat']).id('kubejs:merrymaking/harvest_tray')
  }

...
2. Run this command -> `winget install --id Git.Git -e`
3. Close the terminal
4. Reopen the terminal and run `git version` to check if git is properly installed

## Modpack Installation (Windows)
